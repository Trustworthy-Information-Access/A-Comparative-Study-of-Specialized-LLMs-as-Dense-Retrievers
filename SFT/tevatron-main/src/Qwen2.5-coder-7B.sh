lora_model_save_path='/root/paddlejob/workspace/env_run/output/Qwen2.5-coder-7B/repllama'
model_path='/root/paddlejob/workspace/env_run/model/Qwen2.5-coder-7B'
...
# cd /root/paddlejob/workspace/env_run/output/llm-for-dense/dual-training/llm-index-2/tevatron-main/src/
# sh run-cut50.sh > run-cut50.log
