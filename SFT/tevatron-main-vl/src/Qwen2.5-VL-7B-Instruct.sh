lora_model_save_path='/root/paddlejob/workspace/env_run/output/Qwen2.5-VL-7B-Instruct/repllama'
model_path='/root/paddlejob/workspace/env_run/model/Qwen2.5-VL-7B-Instruct'
...
# deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 60001 --module tevatron.retriever.driver.train_mm \
...
./trec_eval -m ndcg_cut.10 $dev_qrel_path $encode_path/dev_rank.txt.trec
./trec_eval -m ndcg_cut.20 $dev_qrel_path $encode_path/dev_rank.txt.trec
# sh Qwen2.5-math-7b-instruct.sh > Qwen2.5-math-7b-instruct.log
# sh deepseek-r1-distill-Qwen-7B.sh > deepseek-r1-distill-Qwen-7B.log
